...
const PLATFORM_PAGE_ALIASES: Record<string, string[]> = {
  ...
  "/events": ["astronomy calendar", "sky events", "what is happening in the sky", "astronomical calendar", "star gazing calendar"],
  "/events/today": ["tonight sky events", "astronomy today", "what is in the sky today"],
  "/events/this-week": ["sky this week", "astronomy this week"],
  "/events/this-month": ["sky this month", "astronomy this month", "monthly sky guide"],
  "/events/moon": ["full moon date", "new moon date", "moon phase calendar", "supermoon", "lunar perigee", "moon apogee"],
  "/events/eclipses": ["next eclipse", "when is the next solar eclipse", "when is the next lunar eclipse", "eclipse dates", "blood moon"],
  "/events/meteor-showers": ["when is the next meteor shower", "perseids date", "geminids date", "shooting stars tonight"],
  "/events/conjunctions": ["planets close together", "planetary alignment", "conjunction date"],
  "/events/oppositions": ["when is mars closest", "jupiter at its brightest", "saturn opposition date"],
  "/events/launches": ["next rocket launch", "launch schedule", "when is the next launch", "spacex launch date"],
  "/live": ["live astronomy data", "what is happening in space right now", "live space dashboard"],
  "/live/tonight": ["what can I see tonight", "stargazing tonight", "observing plan tonight", "is tonight good for stargazing", "dark sky tonight"],
  "/live/space-weather": ["kp index right now", "is there an aurora tonight", "solar wind right now"],
  "/live/neo": ["asteroid near earth today", "close approach today"],
  "/live/satellites": ["where is the space station right now", "iss position now"],
  "/live/events": ["sky events this week", "astronomy this week"],
...
const PLATFORM_PAGES: [string, string, string, SearchGroupId, string][] = [
  ...
  ["Observing calendar", ROUTES.events, "Live data", "tools", "Dated astronomical events with their provenance: computed instants, NASA eclipse predictions, shower peaks and planned launches."],
  ["Events today", "/events/today", "Live data", "tools", "What is happening in the sky in the next twenty-four hours."],
  ["Events this week", "/events/this-week", "Live data", "tools", "Astronomical events over the next seven days."],
  ["Events this month", "/events/this-month", "Live data", "tools", "The whole calendar month of astronomical events."],
  ["Moon phase dates", "/events/moon", "Live data", "tools", "Every lunar phase and apsis for the year ahead; the phases are checked against NASA's own tables."],
  ["Upcoming eclipses", "/events/eclipses", "Live data", "tools", "Solar and lunar eclipses from NASA's Five Millennium Catalog, converted to UTC."],
  ["Meteor shower dates", "/events/meteor-showers", "Live data", "tools", "Peak nights for the year ahead, with the Moon's interference worked out."],
  ["Planetary conjunctions", "/events/conjunctions", "Live data", "tools", "Planets passing close on the sky, and the dates they vanish into the Sun."],
  ["Planetary oppositions", "/events/oppositions", "Live data", "tools", "When each outer planet is closest, brightest and up all night."],
  ["Upcoming launches", "/events/launches", "Live data", "tools", "Planned orbital launches, with how precisely each date is known and when it was last confirmed."],
  // The live dashboard (Program CN).
  ["Live now", "/live", "Live data", "tools", "What every connected provider is reporting at this moment, with the time each agency measured it."],
  ["Tonight", "/live/tonight", "Live data", "tools", "A personal observing plan for coordinates you type — computed in your own browser and never sent anywhere."],
  ["Space weather now", "/live/space-weather", "Live data", "tools", "The solar wind, Bz and the planetary Kp index right now, and the one thing they decide for an observer."],
  ["Near-Earth objects now", "/live/neo", "Live data", "tools", "How many objects are passing close, and the honest note that none is a naked-eye sight."],
  ["Satellites now", "/live/satellites", "Live data", "tools", "The Space Station's position this second, from NASA's own published trajectory."],
  ["Events this week", "/live/events", "Live data", "tools", "Every dated astronomical event in the next seven days."],
];
