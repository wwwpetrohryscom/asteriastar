...
export function galacticAstronomyPath(slug: string): string {
  return `/galactic-astronomy/${slug}`;
}
export function galacticAstronomyDiscoveryPath(slug: string): string {
  return `/galactic-astronomy/discover/${slug}`;
}
export function astroinformaticsPath(slug: string): string {
  return `/astroinformatics/${slug}`;
}
export function astroinformaticsDiscoveryPath(slug: string): string {
  return `/astroinformatics/discover/${slug}`;
}
export function deepSpaceExplorationPath(slug: string): string {
  return `/deep-space-exploration/${slug}`;
}
export function deepSpaceExplorationDiscoveryPath(slug: string): string {
  return `/deep-space-exploration/discover/${slug}`;
}
export function skyAtlasPath(slug: string): string {
  return `/sky-atlas/${slug}`;
}
...
export function observingPath(slug: string): string {
  return `/observing/${slug}`;
}
...
export function fundamentalPhysicsPath(slug: string): string {
  return `/fundamental-physics/${slug}`;
}
...
export function exoplanetSciencePath(slug: string): string {
  return `/exoplanet-science/${slug}`;
}
export function exoplanetScienceDiscoveryPath(slug: string): string {
  return `/exoplanet-science/discover/${slug}`;
}
export function skyCatalogsPath(slug: string): string {
  return `/sky-catalogs/${slug}`;
}
export function skyCatalogsDiscoveryPath(slug: string): string {
  return `/sky-catalogs/discover/${slug}`;
}
export function deepSkyEncyclopediaPath(slug: string): string {
  return `/deep-sky-encyclopedia/${slug}`;
}
