...
export const CITATION_RECORDS: Citation[] = [
  ...
  c("cite:usno-astronomical-applications", "institutional_page", "USNO Astronomical Applications Department", "United States Naval Observatory", "https://aa.usno.navy.mil/", { license: "Public domain (US Government work)", source: "usno", entityIds: ["moon:the-moon", "star:sun"], notes: "Solar and lunar coordinates, phase, and rise/set/twilight/transit methodology (the Astronomical Almanac); the public-domain formulae behind the computed Moon phase, the computed Sun & twilight times, and the computed moonrise/moonset and lunar position." }),
  ...
  c("cite:noaa-solar-calculator", "institutional_page", "NOAA Solar Calculator", "NOAA Global Monitoring Laboratory", "https://gml.noaa.gov/grad/solcalc/", { license: PUB_US_GOV, source: "noaa", entityIds: ["star:sun"], notes: "Public-domain solar-position algorithm — declination, equation of time, sunrise/sunset, and twilight — the method implemented by the computed Sun & Twilight times." }),
  c("cite:nasa-sun", "institutional_page", "The Sun — NASA Science", "NASA", "https://science.nasa.gov/sun/", { license: PUB_US_GOV, source: "nasa", entityIds: ["star:sun"], notes: "NASA overview of the Sun: our star, its structure, and its role in day, night, and the seasons." }),
  c("cite:jpl-approx-positions", "dataset", "Approximate Positions of the Planets", "NASA Jet Propulsion Laboratory (Caltech)", "https://ssd.jpl.nasa.gov/planets/approx_pos.html", { license: "Public domain (NASA/JPL-Caltech)", source: "jpl", entityIds: ["planet:mercury", "planet:venus", "planet:mars", "planet:jupiter", "planet:saturn", "planet:uranus", "planet:neptune"], notes: "Public-domain Keplerian orbital elements and rates (Standish) — the method behind the computed planet positions, rise/set, and visibility." }),
  c("cite:nasa-planets", "institutional_page", "Planets — NASA Science", "NASA", "https://science.nasa.gov/planets/", { license: PUB_US_GOV, source: "nasa", entityIds: ["planet:mercury", "planet:venus", "planet:mars", "planet:jupiter", "planet:saturn"], notes: "NASA overview of the planets: how the naked-eye planets appear and move through the sky." }),
