...
const DATASET_DEFS: DatasetDef[] = [
  ...
  { slug: "space-weather-provider-status", title: "Space-Weather Provider Status", description: "The honest connection status of the space-weather and solar-activity providers (NOAA SWPC, NASA DONKI). Both are connected end-to-end: solar wind, Kp, the NOAA scales, alerts, flares, active regions, the aurora forecast and the DONKI event catalogues are served live at /space-weather, each with the provider’s own timestamp, cache window and stale threshold.", entityTypes: ["live_data_source"], entityIds: ["live_data_source:noaa-swpc", "live_data_source:nasa-donki"], sources: ["nasa", "noaa"] },
  { slug: "near-earth-object-provider-status", title: "Near-Earth-Object Provider Status", description: "The honest connection status of the near-Earth-object providers (IAU Minor Planet Center, JPL/CNEOS). Both are connected end-to-end: close approaches with their 3-sigma bounds, the Sentry impact-risk table, recent database entries and the MPC confirmation page are served live at /neo, each with the provider's own timestamp and caveats.", entityTypes: ["live_data_source"], entityIds: ["live_data_source:minor-planet-center", "live_data_source:jpl-cneos"], sources: ["nasa", "jpl"] },
  ...
  { slug: "universe-3d-scenes", title: "3D Universe Scenes", description: "The interactive 3D and Canvas scenes of the universe — the to-scale Solar System, the distance-true local stellar neighbourhood, the celestial-sphere constellations, and the descriptive Milky Way and Local Group — each with its honest coverage mode and the measured coordinates it draws on. No position, distance, or coordinate is fabricated.", entityTypes: ["universe_scene"], sources: ["nasa", "hyg"] },
  { slug: "workspace-features", title: "Research Workspace Features", description: "The capabilities of the privacy-first research workspace — saving entities, collections, reading lists, observation projects, notes, a citation folder, and exports — all held only in the browser. No account, no server, no cookie, no tracking.", entityTypes: ["workspace_feature"], sources: ["nasa"] },
  { slug: "platform-capabilities", title: "Open Platform Capabilities", description: "The facets of AsteriaStar as an open, research-grade data platform — the public Graph API, JSON & JSON-LD/RDF exports, dataset and bulk downloads, versioned releases, licensing, and the architecture-ready standards (SPARQL, GraphQL, SDKs, DOI, federation, VO/TAP) — each with its honest status. Nothing is faked.", entityTypes: ["platform_capability"], sources: ["nasa"] },
  { slug: "solar-physics", title: "Solar Physics & Heliosphere", description: "The Sun from core to heliosphere — the concentric interior zones and atmosphere layers (solar regions), the surface and atmospheric features (granulation, prominences, filaments, plages, spicules, coronal loops, streamers), and the structures of the heliosphere (Parker spiral, termination shock, heliosheath, bow wave). Reuses the Sun, the space-weather phenomena, and the solar observatories. Only well-established solar physics; nothing fabricated.", entityTypes: ["solar_region", "solar_feature", "heliosphere_structure"], sources: ["nasa", "esa"] },
  { slug: "compact-objects", title: "Black Holes & Neutron Stars", description: "The compact objects in the graph — black holes (Sgr A*, M87*, Cygnus X-1, V404 Cygni) and neutron stars (the Crab, Vela, first and most-massive pulsars). The physics of these end-states of gravity — the ergosphere, photon sphere, ISCO, jets, neutron degeneracy, the pulsar mechanism and the equation of state — is modelled alongside as reused cosmology, stellar-physics and object-class concepts. Only well-established astrophysics; nothing fabricated.", entityTypes: ["black_hole", "neutron_star"], sources: ["nasa", "eso"] },
  { slug: "astronomy-software", title: "Astronomy Software", description: "The astronomy software ecosystem — the desktop planetariums and imaging/acquisition apps added by the Astronomical Software Ecosystem program (astronomy_software) alongside the scientific tools and libraries (IRAF, CASA, TOPCAT, DS9, Aladin, AstroImageJ, Montage, Skyfield, poliastro, Orekit) and the Astropy ecosystem already in research_software. Only well-established facts (purpose, platforms); nothing fabricated.", entityTypes: ["astronomy_software", "research_software"], sources: ["nasa"] },
  { slug: "observation-techniques", title: "Observation Techniques", description: "The craft of observing — the capture-to-image techniques added by the Professional Observation Techniques program (visual astronomy, astrophotography and its planetary/deep-sky/narrowband variants, autoguiding, calibration frames, image processing, drizzle, plate solving, and the imaging workflow) alongside the frontier lucky/speckle-imaging and image-stacking techniques already in the graph. Only well-established practice; nothing fabricated.", entityTypes: ["observing_technique"], sources: ["nasa", "noirlab"] },
  { slug: "coordinate-and-time-systems", title: "Coordinate & Time Systems", description: "The astrometry and time foundation — the coordinate systems (RA/Dec, equatorial, galactic, ecliptic, horizontal, supergalactic) and the astrometric effects (precession, nutation, aberration, refraction, light-time, Earth orientation) added by the Coordinates, Time & Reference Systems program. Only well-established, standard definitions; nothing fabricated.", entityTypes: ["coordinate_system", "astrometric_effect"], sources: ["iau", "usno"] },
  { slug: "deep-sky-object-classes", title: "Deep-Sky Object Classes", description: "The taxonomy of astrophysical object classes, including the deep-sky classes added by the Deep Sky Objects Encyclopedia (open & globular clusters, stellar associations, the emission/reflection/dark nebula subtypes, HII regions, Bok globules, planetary nebulae, supernova remnants) alongside the compact-object, AGN and large-scale-structure classes. Only well-established astrophysics; nothing fabricated.", entityTypes: ["astrophysical_object_class"], sources: ["nasa", "eso"] },
  { slug: "astronomical-catalogs", title: "Astronomical Catalogs & Designations", description: "The professional catalogue layer — the reference catalogues by which astronomers name and index the sky (Messier, NGC, IC, Henry Draper, Hipparcos, Gaia, Caldwell, Barnard, Sharpless, Abell, PGC, UGC, Gliese, Tycho-2, SAO, GCVS, WDS, LHS, Wolf, the Bonner Durchmusterung), their catalog families, and the Bayer, Flamsteed and variable-star designation systems. Only well-established catalogue facts; unknown counts left empty, nothing fabricated.", entityTypes: ["catalog", "catalog_family", "designation_system"], sources: ["iau", "simbad"] },
];
