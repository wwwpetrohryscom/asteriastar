      ...
      columns: [
        {
          ...
          links: [
            ...
            { name: "Live Scientific Data Platform", href: ROUTES.live, description: "AsteriaStar's connections to real external providers — NOAA SWPC and NASA DONKI are connected and serving live values; near-Earth objects (MPC/CNEOS) and orbital elements remain architecture-ready. Every provider carries an honest status envelope, and no live value is ever fabricated" },
