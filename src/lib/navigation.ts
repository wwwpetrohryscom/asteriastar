      ...
      columns: [
        {
          ...
          links: [
            ...
            { name: "Professional Observatory Planning Suite", href: ROUTES.observing, description: "An observing platform on the graph — tonight, visibility, Moon, planet, deep-sky, season, twilight, darkness, altitude & session planners built on real computed live-sky data, with architecture-ready weather, seeing & Bortle integrations" },
            ...
            { name: "Live Scientific Data Platform", href: ROUTES.live, description: "AsteriaStar's connections to real external providers: seven providers are connected end-to-end — NOAA SWPC, NASA DONKI, JPL/CNEOS, the IAU Minor Planet Center, NASA's ISS ephemeris, NASA/GSFC's eclipse catalogues and the Launch Library schedule — and the two that are not (CelesTrak and a provider of atmospheric conditions) record why. Every provider carries an honest status envelope, and no live value is ever fabricated" },
