      ...
      columns: [
        {
          ...
          links: [
            ...
            { name: "Live Scientific Data Platform", href: ROUTES.live, description: "AsteriaStar's connections to real external providers — space weather (NOAA SWPC), solar activity (NASA DONKI), near-Earth objects (MPC/CNEOS) & orbital elements — each with an honest status envelope; no live value is ever fabricated" },
