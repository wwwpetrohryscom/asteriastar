...
export const SEED_PROVENANCE: ProvenanceRecord[] = [
  ...
  p("launch_vehicle:saturn-v", "The Saturn V was a NASA super heavy-lift launch vehicle that carried the crewed Apollo missions to the Moon and launched Skylab; it stood about 110 m tall and placed roughly 140 tonnes into low Earth orbit.", "high", "confirmed", nasaSci),
  p("launch_vehicle:falcon-9", "Falcon 9 is a partially reusable two-stage RP-1/LOX rocket by SpaceX whose first stage lands and re-flies; it places about 22,800 kg into low Earth orbit in expendable configuration and is human-rated for Crew Dragon.", "high", "confirmed", { organization: "SpaceX", url: "https://www.spacex.com/vehicles/falcon-9/", source: "spacex" }),
  p("launch_vehicle:space-launch-system", "The Space Launch System is NASA's super heavy-lift rocket for the Artemis program; its Block 1 configuration launched the uncrewed Artemis I around the Moon in 2022 and places roughly 95 tonnes into low Earth orbit.", "high", "confirmed", nasaSci),
  p("rocket_engine:f-1", "The F-1 was a gas-generator RP-1/LOX engine; five clustered in the Saturn V first stage, each producing about 6,770 kN of sea-level thrust — the most powerful single-chamber liquid rocket engine ever flown.", "high", "confirmed", nasaSci),
  p("rocket_engine:rs-25", "The RS-25 is a reusable fuel-rich staged-combustion LH2/LOX engine developed as the Space Shuttle Main Engine and now used on the SLS core stage, with a vacuum specific impulse of about 452 seconds.", "high", "confirmed", nasaSci),
  p("rocket_engine:merlin-1d", "Merlin 1D is SpaceX's reusable RP-1/LOX gas-generator engine; nine power each Falcon 9 first stage, producing about 845 kN of sea-level thrust each, with a vacuum-optimized variant on the upper stage.", "high", "confirmed", { organization: "SpaceX", url: "https://www.spacex.com/vehicles/falcon-9/", source: "spacex" }),
  p("rocket_engine:raptor", "Raptor is SpaceX's methane/LOX full-flow staged-combustion engine for Starship and the Super Heavy booster — one of very few full-flow engines flown — designed for high chamber pressure and rapid reuse.", "high", "confirmed", { organization: "SpaceX", url: "https://www.spacex.com/vehicles/starship/", source: "spacex" }),
  p("rocket_engine:rd-170", "The RD-170/RD-171 is a four-chamber oxidizer-rich staged-combustion RP-1/LOX engine — the most powerful liquid-propellant rocket engine ever flown, at about 7,257 kN of sea-level thrust — used on the Energia boosters and Zenit first stage.", "moderate", "confirmed", { organization: "Gunter's Space Page", url: "https://space.skyrocket.de", source: "gunters" }),
  p("launch_vehicle:ariane-5", "Ariane 5 was a European heavy-lift rocket operated by Arianespace, powered by a Vulcain 2 cryogenic core with two solid boosters; it launched the James Webb Space Telescope in 2021 before retiring in 2023.", "high", "confirmed", esa),
  p("launch_vehicle:soyuz", "The Soyuz is a human-rated member of the R-7 rocket lineage — the most-launched family in history — which has carried crews and cargo to orbit for over five decades.", "high", "confirmed", { organization: "Roscosmos", url: "https://www.roscosmos.ru/", source: "roscosmos" }),
];
