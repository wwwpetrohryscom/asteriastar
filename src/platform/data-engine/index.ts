...
import { graphExplorerEngine } from "@/platform/data-engine/graph-explorer-engine";
...
import { webglUniverseEngine } from "@/platform/data-engine/webgl-universe-engine";
import { researchWorkspaceEngine } from "@/platform/data-engine/workspace-engine";
import { groundedAssistantEngine } from "@/platform/data-engine/grounded-assistant-engine";
import { openPlatformEngine } from "@/platform/data-engine/open-platform-engine";
import { solarPhysicsEngine } from "@/platform/data-engine/solar-physics-engine";
import { compactObjectsEngine } from "@/platform/data-engine/compact-objects-engine";
import { fundamentalPhysicsEngine } from "@/platform/data-engine/fundamental-physics-engine";
import { spaceEngineeringEngine } from "@/platform/data-engine/space-engineering-engine";
import { exoplanetScienceEngine } from "@/platform/data-engine/exoplanet-science-engine";
import { skyCatalogsEngine } from "@/platform/data-engine/sky-catalogs-engine";
import { deepSkyEncyclopediaEngine } from "@/platform/data-engine/deep-sky-encyclopedia-engine";
import { referenceSystemsEngine } from "@/platform/data-engine/reference-systems-engine";
import { observationTechniquesEngine } from "@/platform/data-engine/observation-techniques-engine";
import { astronomySoftwareEngine } from "@/platform/data-engine/astronomy-software-engine";
...
export const engine = {
  ...
  graphExplorer: graphExplorerEngine,
  scientificAssistant: scientificAssistantEngine,
  liveScientificData: liveScientificDataEngine,
  webglUniverse: webglUniverseEngine,
  researchWorkspace: researchWorkspaceEngine,
  groundedAssistant: groundedAssistantEngine,
  openPlatform: openPlatformEngine,
  solarPhysics: solarPhysicsEngine,
  compactObjects: compactObjectsEngine,
  fundamentalPhysics: fundamentalPhysicsEngine,
  spaceEngineering: spaceEngineeringEngine,
  exoplanetScience: exoplanetScienceEngine,
  skyCatalogs: skyCatalogsEngine,
  deepSkyEncyclopedia: deepSkyEncyclopediaEngine,
  referenceSystems: referenceSystemsEngine,
  observationTechniques: observationTechniquesEngine,
  astronomySoftware: astronomySoftwareEngine,
...
export type { ResolvedGraphView } from "@/platform/data-engine/graph-explorer-engine";
export type { ResolvedAssistant } from "@/platform/data-engine/scientific-assistant-engine";
export type { ResolvedLiveSource } from "@/platform/data-engine/live-data-engine";
export type { ResolvedScene } from "@/platform/data-engine/webgl-universe-engine";
export type { ResolvedWorkspaceFeature } from "@/platform/data-engine/workspace-engine";
export type { ResolvedCapability } from "@/platform/data-engine/open-platform-engine";
export type { ResolvedSolar } from "@/platform/data-engine/solar-physics-engine";
export type { ResolvedCompact } from "@/platform/data-engine/compact-objects-engine";
