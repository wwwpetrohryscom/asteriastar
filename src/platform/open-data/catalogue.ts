 ...
 *
 * A superset view over the 18 domain datasets plus the graph-level "meta"
...
const META: CatalogueEntry[] = [
  ...
  },
  {
    ...
    description: "The citation framework used to attach formal references to entities and claims. The schema and formatters are implemented; no citations are published in this phase.",
    status: "planned",
    version: GRAPH_VERSION_INFO.datasetVersion,
    schemaVersion: GRAPH_VERSION_INFO.schemaVersion,
    ...
    generatedAt: DATA_GENERATED_AT,
    limitations: "No fabricated references exist. The registry currently holds 0 published citations.",
    updatePolicy: "Populated as claims are formally cited; structure validated on every build.",
  },
  {
