...
import { entities as spaceEnvironmentCatalog } from "@/knowledge-graph/data/space-environment-catalog";
import { entities as missionOperationsCatalog } from "@/knowledge-graph/data/mission-operations-catalog";
import { entities as spacecraftSystemsCatalog } from "@/knowledge-graph/data/spacecraft-systems-catalog";
import { entities as instrumentsCatalog } from "@/knowledge-graph/data/instruments-catalog";
import { entities as planetaryGeologyCatalog } from "@/knowledge-graph/data/planetary-geology-catalog";
import { entities as institutionsCatalog } from "@/knowledge-graph/data/institutions-catalog";
import { entities as spaceflightHistoryCatalog } from "@/knowledge-graph/data/spaceflight-history-catalog";
import { entities as spaceMedicineCatalog } from "@/knowledge-graph/data/space-medicine-catalog";
import { entities as spaceInfrastructureCatalog } from "@/knowledge-graph/data/space-infrastructure-catalog";
import { entities as futureMissionsCatalog } from "@/knowledge-graph/data/future-missions-catalog";
import { entities as astronomyMethodsCatalog } from "@/knowledge-graph/data/astronomy-methods-catalog";
import { entities as timeDomainCatalog } from "@/knowledge-graph/data/time-domain-catalog";
import { entities as galaxiesCatalog } from "@/knowledge-graph/data/galaxies-catalog";
import { entities as astrobiologyCatalog } from "@/knowledge-graph/data/astrobiology-catalog";
import { entities as planetaryDefenseCatalog } from "@/knowledge-graph/data/planetary-defense-catalog";
import { entities as dataArchivesCatalog } from "@/knowledge-graph/data/data-archives-catalog";
import { entities as observatoryFrontierCatalog } from "@/knowledge-graph/data/observatory-frontier-catalog";
import { entities as distanceLadderCatalog } from "@/knowledge-graph/data/distance-ladder-catalog";
import { entities as heliophysicsCatalog } from "@/knowledge-graph/data/heliophysics-catalog";
import { entities as astroMlCatalog } from "@/knowledge-graph/data/astro-ml-catalog";
...
import { entities as galacticAstronomyCatalog } from "@/knowledge-graph/data/galactic-astronomy-catalog";
import { entities as astroinformaticsCatalog } from "@/knowledge-graph/data/astroinformatics-catalog";
import { entities as deepSpaceExplorationCatalog } from "@/knowledge-graph/data/deep-space-exploration-catalog";
import { entities as skyAtlasCatalog } from "@/knowledge-graph/data/sky-atlas-catalog";
import { entities as scientificCalculatorsCatalog } from "@/knowledge-graph/data/scientific-calculators-catalog";
import { entities as observingSuiteCatalog } from "@/knowledge-graph/data/observing-suite-catalog";
...
import { entities as workspaceCatalog } from "@/knowledge-graph/data/workspace-catalog";
import { entities as openPlatformCatalog } from "@/knowledge-graph/data/open-platform-catalog";
...
import { entities as observationTechniquesCatalog } from "@/knowledge-graph/data/observation-techniques-catalog";
import { entities as astronomySoftwareCatalog } from "@/knowledge-graph/data/astronomy-software-catalog";
