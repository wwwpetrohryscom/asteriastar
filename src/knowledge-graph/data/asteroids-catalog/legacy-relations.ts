...
/**
 * Ids of every relation defined OUTSIDE the asteroids catalog. The catalog dedupes
 * its derived relations against this so it enriches the graph without ever
 * duplicating an existing edge — most importantly the mission target/visit edges
 * already emitted by the exploration and solar-system catalogs (e.g. Dawn ↔ Vesta,
 * OSIRIS-REx ↔ Bennu). Asteroids is the newest catalog and is appended last.
 */
