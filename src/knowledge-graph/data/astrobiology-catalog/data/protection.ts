...
export const protection: AstrobiologyRecord[] = [
  ...
  pp({ slug: "backward-contamination", name: "Backward Contamination", relatedKeys: ["mission_program:mars-sample-return"], description: "The risk of bringing potentially hazardous material back to Earth in a returned sample. Sample-return missions are designed to contain their cargo as strictly as the most dangerous pathogens, so nothing escapes before it is shown to be safe.", sources: ["nasa"], highlights: ["Protecting Earth from anything a sample might carry"] }),
  pp({ slug: "sample-handling", name: "Sample Handling & Curation", relatedKeys: ["space_mission:mars-2020", "mission_program:mars-sample-return"], description: "The careful containment, quarantine, and curation of returned samples in specialised facilities — keeping them pristine for science while keeping Earth safe, and preserving them for study by instruments not yet invented.", sources: ["nasa"] }),
];
