...
/**
 * Ids of every relation defined OUTSIDE the citizen-astronomy catalog. The catalog dedupes its derived
 ...
 * and VOEvent. Citizen-astronomy is the newest catalog and is appended last (after astro-ml).
 */
