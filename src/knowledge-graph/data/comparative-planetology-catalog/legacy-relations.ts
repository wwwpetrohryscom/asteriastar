...
/**
 * Ids of every relation defined OUTSIDE the comparative-planetology catalog. The catalog dedupes its derived
 ...
 * and VOEvent. Comparative-planetology is the newest catalog and is appended last (after multi-messenger).
 */
