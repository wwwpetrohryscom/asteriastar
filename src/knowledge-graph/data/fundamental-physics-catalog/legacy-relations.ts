...
/**
 * Ids of every relation defined OUTSIDE the fundamental-physics catalog. The catalog dedupes its derived
 ...
 * neutrino method, IceCube, cosmic rays, and the Sun. Fundamental-physics is the newest catalog and is
 * appended last (after compact-objects).
 */
