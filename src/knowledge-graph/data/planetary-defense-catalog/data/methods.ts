...
export const methods: DefenseRecord[] = [
  me("demonstrated")({ slug: "kinetic-impactor", name: "Kinetic Impactor", relatedKeys: ["space_mission:dart", "space_mission:hera"], description: "Crashing a spacecraft into an asteroid at high speed to nudge its orbit — and getting an extra push from the plume of debris thrown off. NASA's DART did exactly this to the moonlet Dimorphos in 2022, measurably shortening its orbit; ESA's Hera is on its way to study the result up close, arriving in late 2026.", sources: ["nasa"], highlights: ["Demonstrated by DART on Dimorphos in 2022"] }),
  ...
  me("theoretical")({ slug: "nuclear-deflection", name: "Nuclear Deflection", relatedKeys: ["asteroid:bennu"], description: "Detonating a nuclear device near an asteroid — not to blow it apart, but to vaporise a layer of its surface, the escaping material shoving it onto a new course. Studied only as a last resort for the largest objects or the shortest warning times; it has never been tested and remains theoretical.", sources: ["nasa"], highlights: ["A theoretical last resort — never tested"] }),
];
