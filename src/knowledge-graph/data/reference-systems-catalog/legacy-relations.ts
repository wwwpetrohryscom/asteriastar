...
/**
 * Ids of every relation defined OUTSIDE the reference-systems catalog. The catalog dedupes its derived
 ...
 * neutrino method, IceCube, cosmic rays, and the Sun. Reference-systems is the newest catalog and is
 * appended last (after deep-sky-encyclopedia).
 */
