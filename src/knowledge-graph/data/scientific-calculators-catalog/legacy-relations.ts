...
/**
 * Ids of every relation defined OUTSIDE the celestial-mechanics catalog. The catalog dedupes its derived
 ...
 * and VOEvent. Scientific-calculators is the newest catalog and is appended last (after sky-atlas).
 */
