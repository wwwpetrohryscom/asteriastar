...
/**
 * Ids of every relation defined OUTSIDE the space-engineering catalog. The catalog dedupes its derived
 ...
 * neutrino method, IceCube, cosmic rays, and the Sun. Space-engineering is the newest catalog and is
 * appended last (after fundamental-physics).
 */
