...
/**
 * Ids of every relation defined OUTSIDE the discovery-history catalog. The catalog dedupes its derived
 ...
 * and VOEvent. Discovery-history is the newest catalog and is appended last (after space-policy).
 */
