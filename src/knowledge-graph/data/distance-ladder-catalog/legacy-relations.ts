...
/**
 * Ids of every relation defined OUTSIDE the distance-ladder catalog. The catalog dedupes its derived
 ...
 * and VOEvent. Distance-ladder is the newest catalog and is appended last (after observatory-frontier).
 */
