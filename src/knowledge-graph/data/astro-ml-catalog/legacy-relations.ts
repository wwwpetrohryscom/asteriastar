...
/**
 * Ids of every relation defined OUTSIDE the astro-ml catalog. The catalog dedupes its derived
 ...
 * and VOEvent. Astro-ML is the newest catalog and is appended last (after heliophysics).
 */
