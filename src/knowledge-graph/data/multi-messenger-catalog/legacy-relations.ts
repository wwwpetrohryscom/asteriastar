...
/**
 * Ids of every relation defined OUTSIDE the multi-messenger catalog. The catalog dedupes its derived
 ...
 * and VOEvent. Multi-messenger is the newest catalog and is appended last (after citizen-astronomy).
 */
