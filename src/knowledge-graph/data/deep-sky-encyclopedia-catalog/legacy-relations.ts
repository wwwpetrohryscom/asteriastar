...
/**
 * Ids of every relation defined OUTSIDE the deep-sky-encyclopedia catalog. The catalog dedupes its derived
 ...
 * neutrino method, IceCube, cosmic rays, and the Sun. Deep-sky-encyclopedia is the newest catalog and is
 * appended last (after sky-catalogs).
 */
