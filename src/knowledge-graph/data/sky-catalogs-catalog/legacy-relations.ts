...
/**
 * Ids of every relation defined OUTSIDE the sky-catalogs catalog. The catalog dedupes its derived
 ...
 * neutrino method, IceCube, cosmic rays, and the Sun. Sky-catalogs is the newest catalog and is
 * appended last (after exoplanet-science).
 */
