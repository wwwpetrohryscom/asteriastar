...
/**
 * Ids of every relation defined OUTSIDE the space-environment catalog. The catalog dedupes
 ...
 * missions, and the organizations. Space-environment is the newest catalog and is appended
 * last.
 */
export const LEGACY_RELATION_IDS: ReadonlySet<string> = new Set(
  [
    ...
    ...rSmallBodyMissionsCatalog, ...rDeepSpaceCommsCatalog, ...rCore,
  ].map((x) => x.id),
);
