...
/**
 * Ids of every relation defined OUTSIDE the observatory-frontier catalog. The catalog dedupes its derived
 ...
 * and VOEvent. Observatory-frontier is the newest catalog and is appended last (after data-archives).
 */
