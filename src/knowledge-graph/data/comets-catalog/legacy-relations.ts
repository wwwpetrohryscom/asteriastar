...
/**
 * Ids of every relation defined OUTSIDE the comets catalog. The catalog dedupes its
 * derived relations against this so it enriches the graph without ever duplicating an
 * existing edge — most importantly the mission and meteor-shower edges already emitted
 * by the exploration, solar-system, and cross-link catalogs (e.g. Rosetta ↔ 67P,
 * Perseids ↔ Swift–Tuttle). Comets is the newest catalog and is appended last.
 */
