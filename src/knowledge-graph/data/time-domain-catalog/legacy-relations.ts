...
/**
 * Ids of every relation defined OUTSIDE the time-domain catalog. The catalog dedupes its
 * derived relations against this so it enriches the graph without ever duplicating an
 * existing edge — most importantly any edges already touching the reused wavelength bands,
 * multi-messenger methods, surveys, and observatories. Time-domain is the newest catalog and
 * is appended last.
 */
