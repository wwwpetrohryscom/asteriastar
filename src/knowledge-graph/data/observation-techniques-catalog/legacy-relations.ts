...
/**
 * Ids of every relation defined OUTSIDE the observation-techniques catalog. The catalog dedupes its derived
 ...
 * neutrino method, IceCube, cosmic rays, and the Sun. Observation-techniques is the newest catalog and is
 * appended last (after reference-systems).
 */
