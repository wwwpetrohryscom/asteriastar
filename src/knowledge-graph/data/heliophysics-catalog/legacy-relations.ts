...
/**
 * Ids of every relation defined OUTSIDE the heliophysics catalog. The catalog dedupes its derived
 ...
 * and VOEvent. Heliophysics is the newest catalog and is appended last (after distance-ladder).
 */
