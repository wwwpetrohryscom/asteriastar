...
export const components: SysRecord[] = [
  ...
  power({ slug: "rtg", name: "Radioisotope Thermoelectric Generator (RTG)", altNames: ["RTG"], description: "A nuclear power source that converts the heat of decaying plutonium-238 directly into electricity. RTGs let missions operate far from the Sun or through the lunar night — powering Voyager, Cassini, and the Mars rovers.", sources: ["nasa", "jpl"], highlights: ["Powers deep-space missions where sunlight is too weak"] }),
  ...
  prop({ slug: "ion-thruster", name: "Ion Thruster", description: "An electric thruster that ionises a propellant (usually xenon) and accelerates it with electric fields to very high exhaust velocity. It delivers tiny thrust but sips fuel, enabling missions like Dawn and Psyche.", sources: ["nasa", "jpl"], highlights: ["Gentle but ultra-efficient; enabled Dawn and Psyche"] }),
  prop({ slug: "hall-effect-thruster", name: "Hall-Effect Thruster", description: "A type of electric propulsion that traps electrons in a magnetic field to ionise and accelerate propellant. Widely used for satellite station-keeping and increasingly for deep-space missions.", sources: ["nasa", "esa"] }),
  ...
  /* robotics */
  rob({ slug: "robotic-arm", name: "Robotic Arm", altNames: ["Canadarm", "Manipulator arm"], description: "A jointed manipulator used to move cargo, service hardware, capture spacecraft, or collect samples. The Canadarm and Canadarm2 built and service the Space Station; planetary landers carry smaller sampling arms.", sources: ["nasa", "esa"], highlights: ["The Canadarm built and services the ISS"] }),
];
