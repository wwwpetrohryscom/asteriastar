...
import { relations as rExoplanetScienceCatalog } from "@/knowledge-graph/data/exoplanet-science-catalog";
import { relations as rSkyCatalogsCatalog } from "@/knowledge-graph/data/sky-catalogs-catalog";
import { relations as rDeepSkyEncyclopediaCatalog } from "@/knowledge-graph/data/deep-sky-encyclopedia-catalog";
import { relations as rReferenceSystemsCatalog } from "@/knowledge-graph/data/reference-systems-catalog";
import { relations as rObservationTechniquesCatalog } from "@/knowledge-graph/data/observation-techniques-catalog";
import { coreRelations as rCore } from "@/knowledge-graph/data/core-relations";

/**
 * Ids of every relation defined OUTSIDE the astronomy-software catalog. The catalog dedupes its derived
 ...
 * neutrino method, IceCube, cosmic rays, and the Sun. Astronomy-software is the newest catalog and is
 * appended last (after observation-techniques).
 */
