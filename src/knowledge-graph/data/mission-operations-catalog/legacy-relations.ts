...
/**
 * Ids of every relation defined OUTSIDE the mission-operations catalog. The catalog dedupes
 ...
 * missions, and the organizations. Mission-operations is the newest catalog and is appended
 * last.
 */
export const LEGACY_RELATION_IDS: ReadonlySet<string> = new Set(
  [
    ...
    ...rSmallBodyMissionsCatalog, ...rDeepSpaceCommsCatalog, ...rSpaceEnvironmentCatalog, ...rCore,
  ].map((x) => x.id),
);
