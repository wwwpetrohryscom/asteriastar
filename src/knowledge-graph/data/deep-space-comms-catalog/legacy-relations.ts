...
/**
 * Ids of every relation defined OUTSIDE the deep-space-comms catalog. The catalog dedupes
 ...
 * missions, and the organizations. Deep-space-comms is the newest catalog and is appended
 * last.
 */
export const LEGACY_RELATION_IDS: ReadonlySet<string> = new Set(
  [
    ...
    ...rSmallBodyMissionsCatalog, ...rCore,
  ].map((x) => x.id),
);
