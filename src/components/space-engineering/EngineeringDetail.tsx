...
import type { ResolvedEng } from "@/platform/data-engine/space-engineering-engine";
...
import { absoluteUrl, ROUTES, spaceEngineeringPath } from "@/lib/routes";

type Ref = { id: string; name: string; href?: string };

export function EngineeringDetail({ d }: { d: ResolvedEng }) {
  const r = d.record;
  const url = spaceEngineeringPath(r.slug);
  const crumbs: Crumb[] = [
    { name: "Home", url: "/" },
          ...
          <div className="min-w-0 space-y-10">
            ...
            {d.related.length ? (
              <section aria-labelledby="related">
                <h2 id="related" className="font-display text-2xl font-bold">Hardware &amp; related concepts</h2>
            ...
            {d.usedBy.length ? (
              <section aria-labelledby="usedby">
                <h2 id="usedby" className="font-display text-2xl font-bold">Across space engineering</h2>
