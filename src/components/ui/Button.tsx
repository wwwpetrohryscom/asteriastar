...
const VARIANTS: Record<Variant, string> = {
  primary:
    "bg-white text-bg hover:bg-white/90 shadow-[0_0_30px_-8px_rgba(167,139,250,0.6)]",
  secondary:
    "border border-white/15 bg-white/[0.03] text-fg hover:border-white/30 hover:bg-white/[0.06]",
