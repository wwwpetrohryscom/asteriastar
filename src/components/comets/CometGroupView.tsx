          ...
          <aside className="space-y-6">
            ...
            {d.quality && (
              <section className="scientific-card p-5">
                ...
                <p className="mt-3 text-xs leading-relaxed text-faint">Classes, families, and reservoirs follow the NASA/JPL and MPC literature. Unknown values are left blank. See{" "}<Link href="/transparency/source-quality" className="text-nasa underline-offset-4 hover:underline">source quality</Link>.</p>
              </section>
            )}
          </aside>
        </div>
