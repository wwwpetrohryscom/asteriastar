          ...
          <div className="min-w-0 space-y-10">
            ...
            {architecture ? (
              <section aria-labelledby="arch" className="rounded-2xl border border-white/25 bg-white/[0.06] p-5">
                <h2 id="arch" className="font-display text-sm font-semibold uppercase tracking-wider text-white">Architecture-ready</h2>
          ...
          <aside className="space-y-6">
            ...
            {d.quality && (
              <section aria-labelledby="quality" className="scientific-card p-5">
                ...
                <p className="mt-3 text-xs leading-relaxed text-faint">The computed views run real algorithms over the actual graph; every number is counted and every path is a real chain of relations. See{" "}<Link href="/transparency/source-quality" className="text-white underline-offset-4 hover:underline">source quality</Link>.</p>
              </section>
            )}
          </aside>
        </div>
