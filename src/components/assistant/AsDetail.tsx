          ...
          <div className="min-w-0 space-y-10">
            ...
            {architecture ? (
              <section aria-labelledby="arch" className="rounded-2xl border border-white/25 bg-white/[0.06] p-5">
                <h2 id="arch" className="font-display text-sm font-semibold uppercase tracking-wider text-nasa">Architecture-ready</h2>
          ...
          <aside className="space-y-6">
            ...
            {d.quality && (
              <section aria-labelledby="quality" className="scientific-card p-5">
                ...
                <p className="mt-3 text-xs leading-relaxed text-faint">The grounded capabilities surface only facts already in the graph, each with its provenance and a traceable chain of relations. See{" "}<Link href="/transparency/source-quality" className="text-nasa underline-offset-4 hover:underline">source quality</Link>.</p>
              </section>
            )}
          </aside>
        </div>
