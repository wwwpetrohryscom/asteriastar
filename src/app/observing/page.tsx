    ...
    <>
      ...
      <Container className="mt-8 mb-14 space-y-12">
        ...
        <section aria-labelledby="data-heading" className="scientific-card p-5">
          ...
          <p className="mt-2 text-sm text-muted">Each planner and integration is a first-class knowledge-graph entity resolved through the Scientific Data Engine. The planners reuse the computed live-sky data of the platform (twilight, the Moon, the planets) and its observing equipment, sites, and techniques — no ephemeris is re-implemented. The integrations are honest in both directions: cloud cover is CONNECTED, from MET Norway, and fetched by the reader’s own browser so their coordinates never reach this platform; seeing, transparency and Bortle sky brightness are interfaces with no provider behind them and show nothing at all. Cloud cover is never allowed to stand in for seeing or transparency — they are different quantities from different models, and none is ever fabricated. The observing location stays on the device. See{" "}<Link href="/transparency/source-quality" className="text-faint underline-offset-4 hover:underline">source quality</Link>.</p>
        </section>
      </Container>
    </>
  );
