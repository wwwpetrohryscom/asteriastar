        ...
        <section aria-labelledby="discover">
          ...
          <ul className="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {EXPLORATION_DISCOVERIES.map((d) => (
              <li key={d.slug}>
                <Link href={explorationDiscoveryPath(d.slug)} className="group flex h-full flex-col scientific-card p-5 transition hover:-translate-y-0.5 hover:border-white/25 hover:bg-white/[0.04]">
