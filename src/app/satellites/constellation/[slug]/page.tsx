        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_320px]">
          <div className="space-y-10">
            ...
            {d.members.length ? (
              ...
              <section aria-labelledby="members" className="rounded-2xl border border-white/10 bg-white/[0.02] p-5">
          ...
          <aside className="space-y-6">
            ...
            {d.quality && (
              <section className="rounded-2xl border border-white/10 bg-white/[0.02] p-5">
                ...
                <p className="mt-3 text-xs leading-relaxed text-faint">Unknown values are left blank; constellation sizes are given only where well-established. See{" "}<Link href="/transparency/source-quality" className="text-nebula underline-offset-4 hover:underline">source quality</Link>.</p>
              </section>
            )}
          </aside>
        </div>
