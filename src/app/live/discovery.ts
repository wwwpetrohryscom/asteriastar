...
export const BT_DISCOVERIES: BtDiscovery[] = [
  ...
  { slug: "atmospheric", title: "Atmospheric Conditions", category: "atmospheric", description: "The local conditions that decide an observing night. Cloud cover is connected, from MET Norway, and fetched by the reader's own browser; seeing, transparency and Bortle sky brightness still await a licence-safe provider. No condition is ever fabricated.", get: () => e.byCategory("atmospheric") },
];
