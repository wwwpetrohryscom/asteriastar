    ...
    <>
      ...
      <Container className="mt-8 mb-14">
        ...
        <div className="min-w-0 space-y-10">
          <section aria-labelledby="status" className="scientific-card p-6">
            ...
            <dl className="mt-3 grid grid-cols-2 gap-3 text-sm sm:grid-cols-3">
              ...
              <div><dt className="text-faint">Mode</dt><dd className="font-medium text-nasa">{status.mode}</dd></div>
            </dl>
          ...
          <section aria-labelledby="can">
            ...
            <ul className="mt-3 space-y-1.5 text-sm text-muted">
              <li className="flex gap-2"><span className="text-faint">✓</span>Explains an entity from its real description, relations, and cited sources.</li>
              <li className="flex gap-2"><span className="text-faint">✓</span>Compares two entities by their real shared connections.</li>
              <li className="flex gap-2"><span className="text-faint">✓</span>Traces the shortest evidence path between two entities, link by link.</li>
              <li className="flex gap-2"><span className="text-faint">✓</span>Builds a learning path from real relations and curated paths.</li>
              <li className="flex gap-2"><span className="text-faint">✓</span>Summarises the real, source-backed citations behind an entity.</li>
              <li className="flex gap-2"><span className="text-faint">✓</span>Says &ldquo;not enough graph evidence&rdquo; when the graph cannot answer.</li>
            </ul>
          </section>
          ...
          <section aria-labelledby="cannot">
            ...
            <ul className="mt-3 space-y-1.5 text-sm text-muted">
              <li className="flex gap-2"><span className="text-nasa">✗</span>Generate prose or opinions — no language model is configured.</li>
              <li className="flex gap-2"><span className="text-nasa">✗</span>Assert a fact that is not already in the knowledge graph.</li>
              <li className="flex gap-2"><span className="text-nasa">✗</span>Invent numbers, dates, names, or citations to fill a gap.</li>
              <li className="flex gap-2"><span className="text-nasa">✗</span>Persist a conversation — there is no chat history or account.</li>
            </ul>
          </section>
          ...
          <section aria-labelledby="guardrails">
            ...
            <ol className="mt-3 space-y-1.5 text-sm text-muted">
              {status.guardrails.map((g, i) => <li key={i} className="flex gap-2"><span className="text-nasa">{i + 1}.</span>{g}</li>)}
            </ol>
          </section>
